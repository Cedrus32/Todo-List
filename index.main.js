...
const forms = (() => {
    ...
    const _renderProjectForm = function() {
        ...
        let inputTitle = (0,_elements__WEBPACK_IMPORTED_MODULE_1__.input)('text', 'project-title', 'title');

        let labelDescription = (0,_elements__WEBPACK_IMPORTED_MODULE_1__.label)('description', '.project-description');
        let inputDescription = (0,_elements__WEBPACK_IMPORTED_MODULE_1__.input)('text', 'project-description', 'description');
