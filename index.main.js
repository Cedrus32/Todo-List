...
const library = (() => {
    ...
    _events__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe('queryUnsorted', _bundleInstances) // published from domDisplay.js (_openViewQuery)
