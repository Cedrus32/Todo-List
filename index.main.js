...
const sidebar = (() => {
    ...
    const _renderProjectLink = function(project) {
        if (project.id !== 0) {
            ...
            let projectIcon = (0,_elements__WEBPACK_IMPORTED_MODULE_1__.img)(`src/icons/project-icons/${project.icon}.svg`, iconAlt, '');
