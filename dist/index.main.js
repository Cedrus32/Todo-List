...
const display = (() => {
    ...
    const _renderSingletonHeader = function(id, title, dueDate, priority) {
        ...
        let imgPriority = (0,_elements__WEBPACK_IMPORTED_MODULE_1__.img)(`src/icons/priority-${priority}.svg`, imgAlt, `.priority-${priority}`);
