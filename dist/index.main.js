...
const domSidebar = (() => {
    ...
    function _openViewPreferenceQuery(event) {
        ...
        _events_js__WEBPACK_IMPORTED_MODULE_0__["default"].publish('queryUnsorted', 'unsorted', targetReference); // subscribed by library.js
    }
